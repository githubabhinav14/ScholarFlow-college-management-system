...
export default function Buckets() {
  ...
  const buckets = [
    ...
    {
      id: 2,
      title: "Submit Hardcopy of CCNA Certificates",
      description: "Submit the hardcopies of certificates to the class teacher",
    ...
    {
      id: 3,
      title: "5-day Certification Drive ( Student Enablement Program )",
      description: "Machine Learning Foundation Certification 7th to 11th April 2025 From 2:00PM to 4:00PM",
